      ...
      <div className="max-w-6xl mx-auto px-8">
        <ScrollReveal className="mb-24">
          <div className="relative rounded-[3rem] overflow-hidden group shadow-2xl border border-gray-100">
            <VariableSpeedImage src={getVal('about_campus_image', '/rit.jpg')} className="w-full h-[500px] object-cover grayscale-[0.2] group-hover:grayscale-0 transition-all duration-1000" speed={0.05} />
