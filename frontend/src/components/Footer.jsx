...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ backgroundImage: `url('${getVal('footer_bg_image', '/footer_bg_faces.png')}')` }}
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <div className="flex flex-col md:flex-row items-center gap-6 mb-10">
          <div className="bg-white rounded-full shadow-lg flex items-center justify-center w-20 h-20 shrink-0 overflow-hidden border-2 border-white/20">
            <img src={getVal('footer_logo', '/rit-logo.png')} alt="Logo" className="w-14 h-14 object-contain" />
          </div>
        ...
        <div className="flex items-center gap-8 mb-10">
          <a href={getVal('footer_linkedin_url', 'https://www.linkedin.com/school/ramco-institute-of-technology/')} target="_blank" rel="noopener noreferrer" className="hover:text-red-300 transition-colors"><FaLinkedin size={24} /></a>
          <a href={getVal('footer_instagram_url', 'https://www.instagram.com/ramco_rajapalayam/')} target="_blank" rel="noopener noreferrer" className="hover:text-red-300 transition-colors"><FaInstagram size={24} /></a>
          <a href={getVal('footer_facebook_url', 'https://www.facebook.com/RITRajapalayam/')} target="_blank" rel="noopener noreferrer" className="hover:text-red-300 transition-colors"><FaFacebook size={24} /></a>
          <a href={getVal('footer_youtube_url', 'https://www.youtube.com/channel/UCsqlK0-FBItsGzjI9qYiP-g')} target="_blank" rel="noopener noreferrer" className="hover:text-red-300 transition-colors"><FaYoutube size={26} /></a>
        </div>
