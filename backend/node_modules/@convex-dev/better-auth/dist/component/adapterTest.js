...
export const runTests = action(async (ctx, _args) => {
    ...
    const { coreNormalTestSuite, coreAuthFlowTestSuite, additionalFieldsNormalTestSuite, additionalFieldsAuthFlowTestSuite, pluginTableNormalTestSuite, renameFieldAndJoinTestSuite, renameModelUserCustomTestSuite, renameModelUserTableTestSuite, multiJoinsMissingRowsTestSuite, transactionsTestSuite, uuidTestSuite, convexCustomTestSuite, } = await import(adapterFactoryImport);
...
export const runCustomTests = action(async (ctx, _args) => {
    ...
    const authComponent = createClient(baseProfileApi, {
        verbose: false,
    });
