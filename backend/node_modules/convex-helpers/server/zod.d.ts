 ...
 */
export declare const zid: <DataModel extends import("convex/server").GenericDataModel, TableName extends import("convex/server").TableNamesInDataModel<DataModel> = import("convex/server").TableNamesInDataModel<DataModel>>(tableName: TableName) => Zid3<TableName>;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
